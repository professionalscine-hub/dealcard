...
const globalStyles = `
  ...
  * { box-sizing: border-box; transition: all 0.3s ease; outline: none; }
  ...
  /* --- Advanced Breathing Animations --- */
  
  /* 1. Card Outer Glow Breathing */
  ...
  /* 2. Field Border (Always White) & Text (Opposite Glow) */
  @keyframes field-breathe-hot-logic {
    0%, 100% { border-color: #fff; box-shadow: 0 0 15px #fff; color: rgba(255, 71, 87, 0.3); text-shadow: none; }
    50% { border-color: rgba(255, 255, 255, 0.2); box-shadow: 0 0 5px rgba(255, 255, 255, 0.1); color: #fff; text-shadow: 0 0 12px var(--red); }
  }
  @keyframes field-breathe-reg-logic {
    0%, 100% { border-color: #fff; box-shadow: 0 0 15px #fff; color: rgba(0, 119, 255, 0.3); text-shadow: none; }
    50% { border-color: rgba(255, 255, 255, 0.2); box-shadow: 0 0 5px rgba(255, 255, 255, 0.1); color: #fff; text-shadow: 0 0 12px var(--blue); }
  }
  ...
  .field-hot { animation: field-breathe-hot-logic 4s infinite ease-in-out; border: 1.5px solid #fff; }
  .field-reg { animation: field-breathe-reg-logic 4s infinite ease-in-out; border: 1.5px solid #fff; }
  ...
  .deal-card { width: 310px; background: #0d0d12; border-radius: 35px; padding: 65px 20px 15px 20px; margin: 20px auto; position: relative; transition: all 0.5s; }
    ...
    return (
      <div className={`deal-card ${cardGlowClass}`} style={{ opacity: deal.isBlocked ? 0.5 : 1 }}>
        ...
        <div className="price-row">
            ...
            <span className="deal-price" style={{color: deal.isHot ? 'var(--red)' : 'var(--cyan)', textShadow: deal.isHot ? '0 0 10px var(--red)' : '0 0 10px var(--cyan)'}}>₹{deal.price}</span>
        </div>
        <div className="info-grid">
            ...
            <div className={`info-cell ${fieldGlowClass}`} style={{color: 'var(--gold)'}}>STORE: {deal.store.toUpperCase()}</div>
        </div>
